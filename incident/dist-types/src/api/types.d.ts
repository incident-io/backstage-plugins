...
export interface definitions {
    ...
    AuditLogTargetV2ResponseBody: {
         ...
         * @enum {string}
         */
        type: 'announcement_rule' | 'api_key' | 'custom_field' | 'follow_up_priority' | 'incident' | 'incident_duration_metric' | 'incident_role' | 'incident_status' | 'incident_timestamp' | 'incident_type' | 'integration' | 'policy' | 'private_incident_membership' | 'rbac_role' | 'scim_group' | 'severity' | 'status_page' | 'status_page_template' | 'user' | 'workflow';
    };
    /**
    ...
    CatalogTypeV2ResponseBody: {
         ...
         * @enum {string}
         */
        icon: 'bolt' | 'box' | 'briefcase' | 'browser' | 'bulb' | 'clock' | 'cog' | 'database' | 'doc' | 'email' | 'server' | 'severity' | 'star' | 'tag' | 'user' | 'users';
        /**
         * @description ID of this resource
         * @example 01FCNDV6P870EA6S7TK1DSYDG0
         */
    ...
    ExternalIssueReferenceV1ResponseBody: {
         ...
         * @enum {string}
         */
        provider?: 'asana' | 'linear' | 'jira' | 'jira_server' | 'github' | 'shortcut';
    };
    /**
    ...
    ExternalResourceV1ResponseBody: {
         ...
         * @enum {string}
         */
        resource_type: 'pager_duty_incident' | 'opsgenie_alert' | 'datadog_monitor_alert' | 'github_pull_request' | 'sentry_issue' | 'atlassian_statuspage_incident' | 'zendesk_ticket' | 'statuspage_incident';
        /**
    ...
    IdentityV1ResponseBody: {
         ...
         * ]
         */
        roles: ('viewer' | 'incident_creator' | 'incident_editor' | 'manage_settings' | 'global_access' | 'catalog_viewer' | 'catalog_editor')[];
    };
    /**
